          ...
          <>
            ...
            <div className='w-[300px]'>
              <div className='flex flex-col justify-center items-end p-5 space-y-5 mt-14'>
                ...
                <button className='p-3 bg-gray-300 font-bold'>Order Now</button>
              </div>
            </div>
          </>)
          : (<div className='min-h-[80vh] flex flex-col items-center justify-center'><h1 className='text-gray-800 font-bold text-xl mb-2'>Your cart is empty</h1>
            <Link to={'/'}>
